...
#ifndef BRICK_RESOURCE_INJECTED_JS_RESOURCE_PROVIDER_H
#define BRICK_RESOURCE_INJECTED_JS_RESOURCE_PROVIDER_H
...
#endif  // BRICK_RESOURCE_INJECTED_JS_RESOURCE_PROVIDER_H
