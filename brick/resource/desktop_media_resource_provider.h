...
#ifndef BRICK_RESOURCE_DESKTOP_MEDIA_RESOURCE_PROVIDER_H
#define BRICK_RESOURCE_DESKTOP_MEDIA_RESOURCE_PROVIDER_H
...
#endif  // BRICK_RESOURCE_DESKTOP_MEDIA_RESOURCE_PROVIDER_H
